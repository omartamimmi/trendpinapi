...
use Modules\Geofence\Services\RadarService;
...
class GeofenceServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'geofence';
    ...
    private function registerBindings(): void
    {
        // Repositories
        $this->app->bind(
            GeofenceRepositoryInterface::class,
            GeofenceRepository::class
        );

        $this->app->bind(
            UserLocationRepositoryInterface::class,
            UserLocationRepository::class
        );

        $this->app->bind(
            ThrottleLogRepositoryInterface::class,
        ...
        $this->app->bind(
            InterestMatchingServiceInterface::class,
            InterestMatchingService::class
        );
    ...
    protected function registerCommandSchedules(): void
    {
        ...
        //     $schedule->command('geofence:sync')->daily();
        // });
    }
