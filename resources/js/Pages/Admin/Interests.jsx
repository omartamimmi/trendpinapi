...
export default function Interests({ interests, filters: initialFilters }) {
    ...
    const applyFilters = () => {
        ...
        router.get('/admin/interests', activeFilters, { preserveState: true });
    };

    const clearFilters = () => {
        setFilters({ search: '', status: '' });
        router.get('/admin/interests', {}, { preserveState: true });
    };
