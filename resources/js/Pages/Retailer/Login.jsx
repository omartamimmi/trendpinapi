            ...
            <div className="hidden lg:flex lg:w-1/3 items-center justify-center p-8">
                <div className="space-y-6">
                    <div className="flex justify-center">
                        <img src="/images/landing/housing-bank.png" alt="Housing Bank" className="h-16 object-contain" />
                    </div>
                    <div className="flex justify-center">
                        <img src="/images/landing/nbk.png" alt="NBK" className="h-12 object-contain" />
                    </div>
                    <div className="flex justify-center">
                        <img src="/images/landing/kuwait-finance.png" alt="Kuwait Finance" className="h-12 object-contain" />
                    </div>
                </div>
            </div>
        </div>
